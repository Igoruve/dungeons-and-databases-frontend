...
function NotesCardExtended({ notes, onSelect, onRemove, onChange }) {
  ...
  return (
    <article className="article-card-extended">
      ...
      <section className="section-card-extended mt-20">
        {isEditing ? (
          <textarea
        ...
        {!isEditing ? (
          <button
            ...
            className="bg-zinc-50/20 backdrop-blur-sm rounded-full flex flex-row justify-center px-2 py-2 mb-4 mt-2 text-zinc-900 dark:text-zinc-100 shadow-md w-fit fixed right-8 bottom-24"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
          ...
          <div className="flex flex-row">
            <button
              ...
              className=" rounded-full flex flex-row justify-center px-2 py-2 mb-4 mt-2 text-zinc-900 dark:text-zinc-100 bg-zinc-50/20 backdrop-blur-sm fixed bottom-24 left-8 shadow-md"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="32px"
            ...
            <button
              ...
              className=" rounded-full flex flex-row justify-center px-2 py-2 mb-4 mt-2 text-zinc-900 dark:text-zinc-100 bg-zinc-50/20 backdrop-blur-sm fixed bottom-24 right-8 shadow-md"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="32px"
        ...
        {!isEditing && (
          <button
            className="bg-zinc-50/20 backdrop-blur-sm rounded-full flex flex-row justify-center px-2 py-2 mb-4 mt-2 text-zinc-900 dark:text-zinc-100 shadow-md w-fit fixed left-8 bottom-24"
